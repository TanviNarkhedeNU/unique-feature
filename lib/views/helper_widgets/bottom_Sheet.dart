...
///    sheets can be created and displayed with the [showModBottomSheet]
///    function.
///
/// The [BottomSheet] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] and a modal
/// bottom sheet with [showModBottomSheet].
///
/// See also:
///
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showModBottomSheet], for modal bottom sheets.
  const BottomSheet(
      {Key key,
...
///    passed as the `builder` argument to [showModBottomSheet].
...
///  * [showModBottomSheet], which can be used to display a modal bottom
///    sheet.
